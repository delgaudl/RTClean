...
# ontology file
ONTOLOGY_FILE_INPUT = './data/hospital-scenario/hospital.rdf'
ONTOLOG_FORMAT = 'xml'
ONTOLOGY_ATTRIBUTES_PREFIX = 'hosp'
...
DEPENDENCIES_OUTPUT = './data/hospital-scenario/hospital-dependencies.txt'
...
hc.evaluate(fpath='./data/hospital-scenario/hospital_clean.csv',
            tid_col='tid',
            attr_col='attribute',
            val_col='correct_val')
